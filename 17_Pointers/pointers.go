...
/*
Go supports pointers, allowing you pass references to values and records
within your programs.
*/

/*
We’ll show how pointers work in contrast to values with 2 functions:
zeroval and zeroptr. zeroval has an int parameter, so arguments
will be passed to it by value. zeroval will get a copy of ival
