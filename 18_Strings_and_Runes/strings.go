...
The language and the standard library treat strings specially - as containers
of text encoded in UTF-8. In other languages, strings are made of “characters”.
...
func main() {
	...
	/*
		...
		are represented by multiple UTF-8 code points, so the result of this count may be surprising.
	*/
