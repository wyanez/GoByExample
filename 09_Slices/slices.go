...
func main() {
	...
	//By default new slice's capacity is equal to its length;
	//if we know the slice is going to grow ahead of time, it's possible to pass a
	//capacity explicitly as additional parameter to make.
	s = make([]string, 3)
	...
	// len returns the length of slice as expected
	...
	fmt.Println("t is Sorted", slices.IsSorted(t))
